/**
 * ClinicOS: Admin Control Panel & Compliance Dashboard
...
class AdminPanel {
      ...
      <div class="main-content-wrapper">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem; flex-wrap:wrap; gap:1rem; background:var(--bg-surface); border:1px solid var(--border-card); border-radius:var(--radius-lg); padding:1.25rem 1.5rem; box-shadow:var(--shadow-card);">
          <div style="display:flex; align-items:center; gap:1rem;">
            <div style="width:48px; height:48px; border-radius:var(--radius-md); background:var(--secondary); color:#ffffff; display:flex; align-items:center; justify-content:center;">
              <i data-lucide="shield" style="width:24px; height:24px;"></i>
            </div>
            <div>
              <h1 style="font-size:1.6rem; font-weight:800; color:var(--text-navy);">ClinicOS Hospital Administration</h1>
  ...
  renderSubTabContent(state) {
        ...
        <div style="display:flex; flex-direction:column; gap:1.25rem;">
          <div style="display:grid; grid-template-columns:repeat(4, 1fr); gap:1rem;">
            <div class="card" style="padding:1.1rem;">
              ...
              <div style="font-size:1.6rem; font-weight:800; color:var(--text-navy); margin-top:0.25rem;">1,428</div>
            ...
            <div class="card" style="padding:1.1rem;">
              ...
              <div style="font-size:1.6rem; font-weight:800; color:var(--primary); margin-top:0.25rem;">184</div>
          ...
          <div class="card">
            <h3 style="font-size:1.1rem; font-weight:800; color:var(--text-navy); margin-bottom:1rem;">Hospital OPD & Telehealth Performance</h3>
      ...
      return `
        <div class="card">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.25rem;">
            <h2 style="font-size:1.25rem; font-weight:800; color:var(--text-navy);">Medical Specialist Staff (${doctors.length})</h2>
            ...
            ${doctors.map(d => `
              <div style="background:var(--bg-subtle); padding:0.85rem 1rem; border-radius:var(--radius-md); border:1px solid var(--border-card); display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem;">
                <div style="display:flex; gap:0.85rem; align-items:center;">
                  ...
                  <div>
                    <strong style="color:var(--text-navy);">${d.name}</strong>
    ...
    if (this.activeSubTab === 'patients') {
      ...
      return `
        <div class="card">
          <h2 style="font-size:1.25rem; font-weight:800; color:var(--text-navy); margin-bottom:1.25rem;">Registered Patient Directory (${patients.length})</h2>
            ...
            ${patients.map(p => `
              <div style="background:var(--bg-subtle); padding:0.85rem 1rem; border-radius:var(--radius-md); border:1px solid var(--border-card); display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:0.5rem;">
                <div style="display:flex; gap:0.85rem; align-items:center;">
                  ...
                  <div>
                    <strong style="color:var(--text-navy);">${p.name}</strong>
    ...
    if (this.activeSubTab === 'audit') {
      ...
      return `
        <div class="card">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.25rem;">
            <h2 style="font-size:1.25rem; font-weight:800; color:var(--text-navy);">HIPAA & ABDM Compliance Audit Trail</h2>
